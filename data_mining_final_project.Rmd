...
knitr::kable(head(states_education), format="markdown")
```
We will filter the data to only include the year 2013 and remove rows with any na values. Performing this clearing still leaves us with data on all 50 states as well as the District of Columbia. 
